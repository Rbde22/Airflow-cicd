...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-bucket9feb2026")
    bq_project = Variable.get("bq_project", default_var="project-01e6277e-ecd7-4798-ad3")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "890977586545-compute@developer.gserviceaccount.com",
                "network_uri": "projects/project-01e6277e-ecd7-4798-ad3/global/networks/default",
                "subnetwork_uri": "projects/project-01e6277e-ecd7-4798-ad3/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="project-01e6277e-ecd7-4798-ad3",
        region="us-central1",
